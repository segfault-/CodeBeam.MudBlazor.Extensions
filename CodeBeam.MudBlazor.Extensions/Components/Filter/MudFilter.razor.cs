...
namespace MudExtensions
{
    ...
    {
        [Parameter] public MudTreeViewItemM3<Rule<T>> Leaf { get; set; } = new();

        [CascadingParameter(Name = "RootExpression")] public Rule<T> RootExpression { get; set; } = new() { Condition = Condition.AND };
        ...
        private Condition? ParentCondition
        {
            get
            {
                ...
                {
                    return RootExpression.Condition;
                }
            }
        }
        ...
        private void SetLeafCondition()
        {
            ...
            else if (RootExpression != null)
            {
                condition = RootExpression.Condition;
            }
